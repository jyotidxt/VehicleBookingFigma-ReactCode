...
Custom Hooks: Implemented custom hooks to manage swipe and screen click then go to page logic and state efficiently.

Config: Centralized icons for Home Layout.
...
Bash
git clone https://github.com/jyotidxt/figma-to-ReactCode.git
...
Structuring a scalable React project folder system.